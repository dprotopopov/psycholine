...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Application3.config.endpoints);

    var serviceConfig = $.extend(true, {}, Application3.config.services, {
        db: {
    ...
    Application3.db = new DevExpress.data.ODataContext(serviceConfig.db);
