...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline2.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline2.config.services, {
        db: {
    ...
    Storyline2.db = new DevExpress.data.ODataContext(serviceConfig.db);
