...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline17.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline17.config.services, {
        db: {
    ...
    Storyline17.db = new DevExpress.data.ODataContext(serviceConfig.db);
