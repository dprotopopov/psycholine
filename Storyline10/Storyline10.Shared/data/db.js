...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline10.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline10.config.services, {
        db: {
    ...
    Storyline10.db = new DevExpress.data.ODataContext(serviceConfig.db);
