...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline4.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline4.config.services, {
        db: {
    ...
    Storyline4.db = new DevExpress.data.ODataContext(serviceConfig.db);
