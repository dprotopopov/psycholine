...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline21.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline21.config.services, {
        db: {
    ...
    Storyline21.db = new DevExpress.data.ODataContext(serviceConfig.db);
