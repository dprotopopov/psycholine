...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline20.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline20.config.services, {
        db: {
    ...
    Storyline20.db = new DevExpress.data.ODataContext(serviceConfig.db);
