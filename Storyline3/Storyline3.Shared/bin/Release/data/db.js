...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline3.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline3.config.services, {
        db: {
    ...
    Storyline3.db = new DevExpress.data.ODataContext(serviceConfig.db);
