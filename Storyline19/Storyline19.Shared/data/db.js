...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline19.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline19.config.services, {
        db: {
    ...
    Storyline19.db = new DevExpress.data.ODataContext(serviceConfig.db);
