...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline12.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline12.config.services, {
        db: {
    ...
    Storyline12.db = new DevExpress.data.ODataContext(serviceConfig.db);
