...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline6.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline6.config.services, {
        db: {
    ...
    Storyline6.db = new DevExpress.data.ODataContext(serviceConfig.db);
