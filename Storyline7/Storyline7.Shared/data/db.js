...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline7.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline7.config.services, {
        db: {
    ...
    Storyline7.db = new DevExpress.data.ODataContext(serviceConfig.db);
