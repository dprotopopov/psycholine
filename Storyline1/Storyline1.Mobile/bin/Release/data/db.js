...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline1.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline1.config.services, {
        db: {
    ...
    Storyline1.db = new DevExpress.data.ODataContext(serviceConfig.db);
