...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline5.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline5.config.services, {
        db: {
    ...
    Storyline5.db = new DevExpress.data.ODataContext(serviceConfig.db);
