...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline13.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline13.config.services, {
        db: {
    ...
    Storyline13.db = new DevExpress.data.ODataContext(serviceConfig.db);
