...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline14.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline14.config.services, {
        db: {
    ...
    Storyline14.db = new DevExpress.data.ODataContext(serviceConfig.db);
