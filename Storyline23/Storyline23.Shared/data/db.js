...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline23.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline23.config.services, {
        db: {
    ...
    Storyline23.db = new DevExpress.data.ODataContext(serviceConfig.db);
