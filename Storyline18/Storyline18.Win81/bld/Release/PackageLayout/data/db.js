...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline18.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline18.config.services, {
        db: {
    ...
    Storyline18.db = new DevExpress.data.ODataContext(serviceConfig.db);
