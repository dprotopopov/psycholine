...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline22.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline22.config.services, {
        db: {
    ...
    Storyline22.db = new DevExpress.data.ODataContext(serviceConfig.db);
