...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Application2.config.endpoints);

    var serviceConfig = $.extend(true, {}, Application2.config.services, {
        db: {
    ...
    Application2.db = new DevExpress.data.ODataContext(serviceConfig.db);
