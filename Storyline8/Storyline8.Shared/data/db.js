...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline8.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline8.config.services, {
        db: {
    ...
    Storyline8.db = new DevExpress.data.ODataContext(serviceConfig.db);
