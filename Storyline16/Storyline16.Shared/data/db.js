...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline16.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline16.config.services, {
        db: {
    ...
    Storyline16.db = new DevExpress.data.ODataContext(serviceConfig.db);
