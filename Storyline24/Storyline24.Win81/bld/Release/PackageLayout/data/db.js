...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline24.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline24.config.services, {
        db: {
    ...
    Storyline24.db = new DevExpress.data.ODataContext(serviceConfig.db);
