...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline9.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline9.config.services, {
        db: {
    ...
    Storyline9.db = new DevExpress.data.ODataContext(serviceConfig.db);
