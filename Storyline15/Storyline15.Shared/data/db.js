...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(Storyline15.config.endpoints);

    var serviceConfig = $.extend(true, {}, Storyline15.config.services, {
        db: {
    ...
    Storyline15.db = new DevExpress.data.ODataContext(serviceConfig.db);
